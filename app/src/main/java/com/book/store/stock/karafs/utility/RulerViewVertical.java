...
public class RulerViewVertical extends View {
    ...
    public RulerViewVertical(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        type = Typeface.createFromAsset(context.getAssets(), "fonts/iransans.ttf");
    }

    public RulerViewVertical(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
        type = Typeface.createFromAsset(context.getAssets(), "fonts/iransans.ttf");
    }


    public RulerViewVertical(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
